...
`brajeshwar.com` is the personal website of **Brajeshwar Oinam**.
...
- __Company__ (referred to as either “I”, “the Company”, “We”, “Us” or “Our” in this Agreement) refers to **Brajeshwar Oinam**.
...
- __Website__ refers to `brajeshwar.com`, accessible from [brajeshwar.com](https://brajeshwar.com).
...
1. **Acceptance of Terms.** By accessing or using this website, you agree to these Terms of Service. If you do not agree, do not use the site.
2. **Purpose of the Website.** This website is a personal site used to share writing, ideas, and information. All content is provided for general informational purposes only.
3. **Intellectual Property.** Unless stated otherwise, all content on this site, including text, images, and design, is owned by the site owner. You may read, share links, and quote short excerpts. You may not reproduce or republish content in full without permission.
4. **No Professional Advice.** Content on this website does not constitute legal, financial, medical, or professional advice. You use the information here at your own risk.
5. **External Links.** This site may contain links to external websites. The site owner is not responsible for the content, accuracy, or practices of those third-party sites.
6. **User Conduct.** If you interact with the site (for example, via comments or messages), you agree not to post unlawful, abusive, or malicious content. The site owner reserves the right to remove content at their discretion.
7. **Disclaimer.** This website and its content are provided “as is,” without warranties of any kind. The site owner makes no guarantees regarding accuracy, completeness, or availability.
8. **Limitation of Liability.** The site owner will not be liable for any damages arising from the use or inability to use this website.
9. **Changes to These Terms.** These Terms may be updated at any time. Continued use of the site after changes means you accept the updated Terms.
10. **Contact.** For questions about these Terms, you can contact the site owner through the contact information provided on this website.
