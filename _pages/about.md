...
My `brajeshwar.com` was [registered on Jun 11, 2001](/about/brajeshwar.com/), that started my fascination with owning a piece of the Internet.
...
In 2005, I decided to take the plunge, go official, and started our first company, Oinam Software. We undertook some of the most innovative, sometimes very experimental work for clients, such as
...
## Oinam Software’s Acquisition

2006

<figure class="timeline-figure">
  <img src="/static/album/2006-04-08-oinam-software-acquired-by-nanocast.webp"
  alt="Oinam Software Team" width="600" height="450" loading="lazy" decoding="async">
  <figcaption>Oinam Software Team acquired by Mixercast.</figcaption>
</figure>
...
I met Shanta in 2006. We got [married in July 2007](/2007/brajeshwar-and-shanta-got-married-on-07-07-07/).

## Laaija

2008

Our first daughter, [Laaija](/2008/laaija/), was born in Imphal in December 2008.

## Amara

2016

Our second daughter, [Amara](/2016/amara/), was born in Bangalore in November 2016.
...
─────────────────────────────────────────────────────────────
  ...
  - `##` is an entry, styled like every other Heading-2 on the site.
  - The line directly under it is its sub-title — a date, a role, a place.
    Keep the blank line between them, or it reads as prose.
  - Everything after is prose. No classes, no ids, no HTML.

  There are no period labels any more; each entry carries its own date.
