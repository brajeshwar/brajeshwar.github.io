...
- [Dithered](https://www.dithered.com/css_filters/)
- [Will the browser apply the rule(s)?](https://centricle.com/ref/css/filters/)
- [How to hide CSS from buggy browsers](https://w3development.de/css/hide_css_from_browsers/)
- [Tricking Browsers and Hiding Styles](https://www.ericmeyeroncss.com/bonus/trick-hide.html)
