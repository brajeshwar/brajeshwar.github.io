...
Surprisingly this new super-computer storage system being created in [IBM's Almaden](https://almaden.ibm.com/), California facility actually has a use. Even more surprising is that they already have a customer for it; a client running in-depth simulations for a super computer detecting real world weather and climate phenomena.
