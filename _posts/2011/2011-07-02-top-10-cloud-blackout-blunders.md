...
In April [Amazon's Web Service's](https://aws.amazon.com/) customers were left in the dark when their Northern Viginia data center went kaput after a re-mirroring storm. While many of their customer's weathered the storm via redundancies set up previously-like Netflix-others suffered greatly during the four day blackout. 

## Blackout Blunder Number 5: Sidekick's Stumble

In the fall of 2009 T-Mobile's [Sidekick](https://sidekick.t-mobile.com/) screwup left  Sidekick users in a week-long service blackhole-only to later add insult to injury by losing many users' personal information stored on the units as they forgot to back it up. Whoops.
