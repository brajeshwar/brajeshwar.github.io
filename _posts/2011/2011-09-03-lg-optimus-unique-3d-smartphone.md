...
3D Videos can be uploaded directly from the phone and can be shared to the rest of the world using YouTube's dedicated website - [www.youtube.com/3D](https://www.youtube.com/3D). You can [connect the smartphone to other electronic gadgets](https://www.computerworld.com/s/article/9217878/Coming_with_3D_Smartphones_from_Sprint_AT_T) using either HDMI or DLNA cables. LG Optimus 3D can perform the function of a modem. Your smartphone works like an instant Wi-Fi hotspot. It can be connected to a laptop or computer using USB cable, which can be set as external drive from the Notifications pull-down menu. You can drag and drop whichever item you want on the smartphone. 
...
A new era has started in the [world of smartphones](https://www.pcworld.com/article/223137/3d_smartphones_gamechanger_or_gimmick.html) with the addition of 3D facility. Are you prepared to take this new leap?
