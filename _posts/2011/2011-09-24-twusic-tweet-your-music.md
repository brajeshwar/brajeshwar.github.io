...
Actually, there are many tweets containing the [#nowplaying](https://twitter.com/#!/search/%23nowplaying) hashtag, thanks to all the music services that allow users to automatically push their music onto their Twitter account.
