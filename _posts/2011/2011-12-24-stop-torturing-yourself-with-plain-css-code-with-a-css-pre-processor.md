...
There are quite a few popular CSS pre-processor available now -- [LessCSS](https://lesscss.org/), [Sass](https://sass-lang.com/) and [Stylus](https://learnboost.github.com/stylus/). Personally, I prefer Sass with `scss` syntax but it is just a preference and you're free to pick a choice of your own.
...
- [CompassApp](https://compass.handlino.com/) (Win, Mac, Linux) helps you compile stylesheets easily without resorting to command line interface.
- [CodeKit](https://incident57.com/codekit/) automatically compiles Less, Sass, Stylus, CoffeeScript & Haml files. It effortlessly combines, minifies and error-checks Javascript. It even optimizes jpeg & png images, auto-reloads your browser and lets you use the same files across many projects.
- [LiveReload](https://livereload.com/) monitors changes in the file system. As soon as you save a file, it is preprocessed as needed, and the browser is refreshed.
