...
Just when we thought that Symbian had joined the technology graveyard -- buried alongside the [Betamax](https://en.wikipedia.org/wiki/Betamax) and [AmigaOS](https://en.wikipedia.org/wiki/AmigaOS), it gets OS CPR.
