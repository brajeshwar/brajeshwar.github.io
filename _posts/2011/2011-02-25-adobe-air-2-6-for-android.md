...
Adobe AIR 2.6 for Android smartphones and tablets is [now available](https://blogs.adobe.com/air/2011/02/adobe-air-2-6-for-android-is-now-available.html).  AIR 2.6 for Android adds support for Android 3.0 and the latest Android tablet devices - including the Motorola Xoom - as well as improvements to performance and GPU-based rendering, updated Android gesture support, and improved handling of HTML content within AIR apps.
...
Here is the [list of mobile devices](https://www.adobe.com/flashplatform/certified_devices/) that meet the AIR system requirements.
