...
- [Navigation](https://www.google.com/mobile/navigation/), though essential, consumes a lot of data when retrieving map images, of almost one megabyte a minute. It can be used for long periods of time when away from Wi-Fi, especially while driving.
