...
This is the reason behind a probable Apple - Hulu deal. [Hulu](https://www.hulu.com/) was the one who initiated by an advertisement calling for top smartphone companies to buy them to stream movies for the smartphones. [Microsoft](https://www.microsoft.com/) and [Google](https://www.google.com/) tried to acquire the opportunity but it seems they were dropped out from the contract and the contract is most likely to be signed by [Apple](https://www.apple.com/). Although, clear reasons behind the withdrawal by Google and Microsoft from this contract is unknown, Hulu App is available in the Google's Android and Microsoft's Windows devices. 
...
Apple is already ruling with iTunes and it's also offering you to watch movies and TV shows through [Apple TV Product](https://www.apple.com/appletv/) from the iTunes store. Sources from Apple developer side says that the viewing movies and TV shows by using a streaming expert like Hulu is more effective than to do the same through the Apple TV product or any other newer developments.

Hulu has recently [renewed its licensed deal with Fox](https://www.variety.com/article/VR1118038960); the license of Hulu seems to be more remarkable for potential buyers says experts.
