...
Recently I was in talk with the founder of [SnappyFingers](https://www.snappyfingers.com/), talking mostly about their Technology usage - Python, AWS, etc. It's interesting and nice that many startups are now taking advantage of readily available high-end infrastructures via the Cloud.

SnappyFingers was even [featured by AWS](https://aws.typepad.com/aws/2009/03/european-success-stories.html) on their usage of Amazon's services.[SnappyFingers](https://www.snappyfingers.com/) is a Question and Answer search engine. It's goal is to search for answers amongst Questions and Answers spread across the Internet. Whether you are doing research or home work, or you just have a plain old question, you will probably find SnappyFingers to be of use.
