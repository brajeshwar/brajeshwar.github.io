...
Netbooks are basically designed to be used with the Internet and apart from a [small hard drive](https://news.cnet.com/8301-13924_3-10145481-64.html?part=rss&amp;subj=news), the availability of USB ports allow a secondary storage device to be plugged in. One can also use a small SD-card flash memory into one of the ports, made available for the reading memory cards.

Here is a [comparative study of Netbooks](https://en.wikipedia.org/wiki/Comparison_of_netbooks) which prevail in the existing market. I am sure you'll love it!
