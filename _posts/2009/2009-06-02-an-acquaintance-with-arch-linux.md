...
<p><img src="{{ site.baseurl }}/assets/2009/06/archlinux.jpg" alt="Arch Linux" style="float: right; margin: 0 0 0 10px; border: 0 none;" /> Before you jump on to download an <em>.iso</em>, you may want to check out the <a href="http://www.archlinuxgallery.com/">Arch Linux gallery</a> that carries some beautiful screenshots.</p>
