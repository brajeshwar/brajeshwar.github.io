...
Today, let me chronicle some of the tools, utilities I stumbled upon and I hope that it will be useful to other web developer/designers. Our team embraced semantic and well marked-up HTML long back and [HTML5](https://www.w3.org/TR/html5/) is proving to be a boon for us. But for this article, let's keep HTML5 for another sunny day and let me just talk CSS.
...
- [Compass](https://wiki.github.com/chriseppstein/compass)
- a little bit of [Susy](https://github.com/ericam/compass-susy-plugin)
...
Before going ahead, let me say that I like Nathan Borror's article -- [Sass isn't for me](https://nathanborror.com/posts/2009/nov/30/sass-isnt-me/) and the reasoning behind it. Fortunately, Sass is for me and will be for most of you. Of course, i'll tell you how we manage 3000+ lines of CSS codes with Sass without having to scroll much and without having to wait for compass to compile those 'ballooning' 10,000+ lines Sass codes.
...
Let's look at a simple example (excerpt from the [Sass](https://sass-lang.com/) website)
...
Which means you can use that "table-scaffolding" mixin again and again wherever you need it. Sass is easy to start and the best place to would be to visit the [Sass Tutorial](https://sass-lang.com/tutorial.html). Read below for Sass installation and usage.

## Compass

For me, the need for [Compass](https://wiki.github.com/chriseppstein/compass) was just to supplement Sass compilation without my intervention. I was ready to jump into Sass without any gears or tools or frameworks. However, Compass was a pleasant surprise for me and I'm loving every bit of it now.

Once Compass is installed, it comes built-in with the [following frameworks](https://wiki.github.com/chriseppstein/compass/supported-frameworks) ready for you:
...
And here are some of the popular [Compass-Plugins](https://wiki.github.com/chriseppstein/compass/compass-plugins) you can add:
...
Honestly, it was the name that strike me and I'm not complaining my choice of this particular Compass Plugin. [Susy](https://www.oddbird.net/susy/) is a grid and utility plugin for Compass. Susy helps you do away with some of the calculations you always do when you deal with the [CSS Box Model](https://www.w3.org/TR/CSS2/box.html) (understand it better with the interactive [CSS Box Model](https://redmelon.net/tstme/box_model/)).
...
Ah! that's because Sass is part of [Haml](https://haml-lang.com/) Project.

## Few introductory Best Practices

We always want to know how to get things started ASAP and with anything new, we want a primer, guidelines, demos, working examples. I would suggest reading on the Tutorials, examples and documentations a bit on [Compass](https://github.com/chriseppstein/compass) and [Sass](https://sass-lang.com/).
...
- [LessCSS](https://lesscss.org/) -- I've heard good reviews about LessCSS, another CSS-Preprocessor like Sass. It's just that I've never tried it seriously.
