...
- Emergence of web based start-ups which could eventually reach good heights. These include [Twitter](https://twitter.com), [Facebook](https://facebook.com), [Youtube](https://youtube.com), [Orkut](https://orkut.com) and many more. A web based startup does not involve large amount of initial investment and if the product gets popular, a lot of VC's step in to escalate the ranch.
...
- [Recession](/2009/recession-and-foss/) for sure has given birth to a lot many freelancers which turn on to start a company if things go well for them. Decrease in the number of job opportunities has led many fresh graduates to utilize their talent and work on freelance projects.
...
- Emergence of events like [BarCamp](https://www.barcamp.org), [iAccelerator](https://iaccelerator.org/), [Proto](https://www.proto.in), [HeadStart](https://headstart.in/) and other have created a good knowledge amongst people to understand what lies beneath this ecosystem and how can things work well (not always though!).
- Mentors like [Paul Graham](https://ycombinator.com/) and others are now popular across the pan-asian countries. Thanks to [WordPress](https://www.wordpress.com), [Blogspot](https://blogger.com) and other publishing platforms which created a wave of online journalism and blogging.
