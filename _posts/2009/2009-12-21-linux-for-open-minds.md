...
Once upon a time in a land far away, [Andrew Tanenbaum](https://en.wikipedia.org/wiki/Andrewp_S._Tanenbaum)'s 12,000 lines of code served as the start point for a young lad called [Linus Torvalds](https://en.wikipedia.org/wiki/Linus_Torvalds) to release Linux version 0.01 in 1991. Since then Linux has come a long way and is only geared for more growth and glory.

Today that journey continues and [openSUSE](https://www.opensuse.org/), a community project sponsored by Novell has just released version 11.2. What can we expect from this spanking new version?
