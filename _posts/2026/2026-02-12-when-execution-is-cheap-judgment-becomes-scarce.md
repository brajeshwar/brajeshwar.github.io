...
When [Stripe](https://stripe.com) was still small, the Collison brothers decided to focus on a handful of their Startup cohort at [Y Combinator](https://www.ycombinator.com). They had interest from hundreds of potential customers but chose depth over breadth.
...
A decade ago, a decent GTM operator won by outworking competitors. More calls, more content, more meetings. Effort was the limiting factor. Today, every team has access to the same execution leverage. [AI](https://en.wikipedia.org/wiki/Artificial_intelligence) writes the emails, automation books the meetings, and analytics surfaces the signals.
...
When [Salesforce](https://www.salesforce.com) was expanding beyond its initial SMB success into enterprise accounts, [Marc Benioff](https://en.wikipedia.org/wiki/Marc_Benioff) started flying to meet with individual CIOs at large enterprises, spending days on single accounts that hadn’t committed to anything. The execution machine was working. Benioff read something different.
...
Enterprise required a different motion entirely. He studied political landscapes, understood [procurement cycles](https://en.wikipedia.org/wiki/Procurement), and built relationships that would take years to convert. Recognising when the playbook needs to change, even while the current one works, is what separated Salesforce from competitors who kept applying an SMB playbook at larger companies.
...
[Snowflake](https://www.snowflake.com)’s early GTM shows what this looks like in practice. They entered a market with entrenched players: Oracle, AWS, traditional [data warehouses](https://en.wikipedia.org/wiki/Data_warehouse). Every competitor had more resources, more salespeople, more marketing budget. Snowflake couldn’t outspend them on execution.
