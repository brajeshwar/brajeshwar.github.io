...
- Cleaning brittle build systems.
- Automating repetitive steps.
- Updating neglected infrastructure.
...
2. **Write the original goal down.** Physically. [On Paper.](/2025/notes/) Preferably with a fountain pen, so it feels morally binding.
...
So next time you sit down to send a simple email and end up upgrading your router firmware, refactoring your [dotfiles](https://github.com/brajeshwar/dot), reorganizing your desk, and questioning your life choices, take comfort in the fact that you’re not wasting time.
