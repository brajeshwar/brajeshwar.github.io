...
ColdFusion 8 includes the Adobe LiveCycle Data Services ES (formerly Flex Data Services) and other data exchange improvements to simplify the data-enabling of rich Internet applications (RIAs) you build with ColdFusion and [Flex](https://www.adobe.com/go/flex/).
...
[Get your License Today](https://www.adobe.com/products/coldfusion/buy/).

## REFERENCES

- Adobe's [Press Release](https://www.adobe.com/aboutadobe/pressroom/pressreleases/200707/073007ColdFusion.html) on the release of ColdFusion 8
- [Features](https://www.adobe.com/products/coldfusion/features/) of the current ColdFusion version
- ColdFusion 8 [Feature Demos](https://www.adobe.com/products/coldfusion/demos/)
- PDF of the ColdFusion 8 [performance brief](https://www.adobe.com/products/coldfusion/pdfs/cf8_performancebrief.pdf)
- PDF of the ColdFusion 8 [System Support Matrix](https://www.adobe.com/products/coldfusion/pdfs/cf8_systemsupportmatrix.pdf)