...
The <a href="https://bangalorefx.org/">Bangalore-based Flex User Group</a> is organizing the first of its kind RIA event in India - <a href="https://initRIA.org">initRIA</a>. It is an event focussed specific to Rich Internet Application Development with an aim to provide a platform for RIA enthusiasts in India to interact and learn.

You can help or contribute to the event in multiple ways, of course, the best being to <a href="https://initria.org/register.php">participate</a> in the event. Other ways to be part of the event;
