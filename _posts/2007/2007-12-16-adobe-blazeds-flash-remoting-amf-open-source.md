...
On December 13th, Adobe [announced](https://www.adobe.com/aboutadobe/pressroom/pressreleases/200712/121307BlazeDS.html) plans to release source code for its remoting and messaging technologies under a new open source product named [BlazeDS](https://www.adobe.com/go/blazeds/). BlazeDS is currently available as [beta](https://labs.adobe.com/technologies/blazeds/) on Adobe Labs.
...
[Peter Farland](https://blogs.adobe.com/pfarland/), of the Adobe Flex Team, urges the community to take advantage of the Proxy Service and to contribute to its functionality going forward;
