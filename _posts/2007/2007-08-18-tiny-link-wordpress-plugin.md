...
Well, [Tiny Link](https://wordpress.org/extend/plugins/tiny-link/) is a Wordpress plugin that creates an alternate [TinyURL](https://tinyurl.com/) link to your article or post permalink.
...
Download [Tiny Link](https://wordpress.org/extend/plugins/tiny-link/) from Wordpress.
