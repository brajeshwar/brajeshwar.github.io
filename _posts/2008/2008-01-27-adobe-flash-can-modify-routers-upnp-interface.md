...
Security firms and Interested Institutes keeps stumbling on security issues and vulnerabilities almost every waking hour of the day. Very recently, Google Researchers documented serious [vulnerabilities in Adobe Flash SWFs](/2007/google-researchers-found-vulnerabilities-in-flash/). Another Flash related security issues surfaced about a weeks ago that the Universal Plug and Play (UPnP) interface of [your Router may be highly vulnerable](https://www.gnucitizen.org/blog/hacking-the-interwebs) to use by hackers seeking to modify their settings -- such as choice of DNS Server -- from an external location using Flash.
...
You can [download](https://www.gnucitizen.org/blog/hacking-the-interwebs) a Harmless/Useless Proof of Concept code from GNU Citizen, for demonstration and eduction purposes.
