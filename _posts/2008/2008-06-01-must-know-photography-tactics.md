...
Photography fascinates many people and it turns out to be a good opportunity when a good blogger told me he wishes to write. Incidentally, [Praval's](https://www.praval.com/) first article is something about Photography.
...
1. Portraits
1. Landscape
1. Vary your shooting angle
1. Steady the camera for sharp pictures
1. Framing the shot
1. Use movement
1. Getting the exposure right
1. Use the appropriate camera setting
1. Using white balance
1. Using zoom
1. Focus
1. Use flash creatively
1. Experiment
...
- Focal length: 38 mm
- Aperture: F16 (as small an f/stop as is available for proper exposure)
