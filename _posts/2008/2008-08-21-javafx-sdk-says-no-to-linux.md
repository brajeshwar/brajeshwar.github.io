...
After the advent of SDKs for Adobe AIR & Microsoft Silverlight and the considerable amount of market share they already have, Sun Microsystems has finally come up with their SDK preview for [JavaFX](https://www.javafx.com/). This was a result of two years of hard work so as to allow developers to play with the JavaFX technology. This may be a step too late, but it's not bad than never. It reminds me of the Open Source equivalent which also competes as a Rich Internet Application (RIA) development & delivery tool named - [OpenLaszlo](https://www.openlaszlo.org/). It is released under the [Open Source Initiative](https://en.wikipedia.org/wiki/Open_Source_Initiative)-certified [Common Public License](https://en.wikipedia.org/wiki/Common_Public_License).
...
Something that surprised me - The [JavaFX home page](https://www.javafx.com/) doesn't actually use JavaFX! It uses Ajax and Quicktime movies. Now that's something strange and noticeable. What do you have to say?