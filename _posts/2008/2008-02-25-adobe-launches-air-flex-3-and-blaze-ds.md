...
VentureBeat [wrote](https://venturebeat.com/2008/02/24/adobe-air-launches-a-flood-of-webdesktop-hybrids-to-follow/) that the official launch of Adobe AIR puts it ahead of competitors -- [JavaFX](https://www.sun.com/software/javafx/) and [Mozilla Prism](https://wiki.mozilla.org/Prism) -- which are still in development or beta stage. Michele Turner, Adobe vice president of product management and marketing, says that treating Microsoft [Silverlight](https://silverlight.net/) as a competitor is a misconception, "Silverlight is a browser plug-in, not a desktop runtime environment."
...
Adobe Flex Builder 3 is available for immediate purchase from Adobe starting at $249 or upgrade from an earlier version for just $99. You can also download a FREE [60 days trial](https://www.adobe.com/go/flex_trial) of Adobe Flex Builder 3.
...
Adobe is also going great guns with Open Source. [Adobe Open Source](https://opensource.adobe.com/) presents the definitive view into open source activities at Adobe, including details regarding projects that Adobe participates in and hosts. It also highlights information that will help developers and designers alike get involved and keep up with the latest work in the Adobe open source community.

To put their effort towards Open Source initiatives, Adobe recently release the open Source [Blaze DS](https://www.adobe.com/go/blazeds/) and today they've the Flex 3 SDK. Adobe is also involved with Mozilla's [Tamarin](https://www.mozilla.org/projects/tamarin/) Project.