...
This is the beginning of a new phenomena -- Google, the leader in Search -- will now be able to index textual content in Flash files of all kinds -- Flash menus, buttons to banner, to self-contained Flash websites. Google have [launched their Flash indexing algorithm](https://googleblog.blogspot.com/2008/06/google-learns-to-crawl-flash.html), we can expect improved visibility of Flash content, with better search results and snippets.
...
Ted's got a nice, short and sweet explanation on [how this works](https://www.onflex.org/ted/2008/06/searchable-swf.php); 
