...
About a month earlier, Adobe shipped [AIR v1.0 for Windows and Mac](/2008/adobe-launches-air-flex-3-and-blaze-ds/) but delayed the Linux release as Adobe had to "wait on the core Flash Player's support for Linux to be finalized."
...
Linux developer can use the [Flex Builder for Linux alpha](https://labs.adobe.com/technologies/flex/flexbuilder_linux/) or any text editor. In addition, since AIR applications run across operating system, you can use Flex Builder, Dreamweaver or Flash if your primary development machine runs on OSX or Windows.