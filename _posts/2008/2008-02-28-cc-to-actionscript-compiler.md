...
While browsing around Flash/Flex blogs, I stumbled on an interesting article from Ted -- [Extending Adobe Flash Player and Adobe AIR with C and C++](https://www.onflex.org/ted/2008/02/extending-adobe-flash-player-and-adobe.php) via ActionScript 3.
