...
In our previous article - [Thinking about career in Linux? Part 1](/2008/career-in-linux-1/), we saw some of the prerequisites which shall help you build a career in Linux, or the Open Source technology. As promised, we move on from where we took a pause, to discuss some more tools/applications which fall under the same category.
...
You may prefer reading the [Perl manual](https://linux.die.net/man/1/perl), for that matter.
...
Lookout for the [PHP documentation](https://www.php.net/docs.php).
...
Checkout the [Postfix official documentation](https://www.postfix.org/documentation.html).
...
A detailed [documentation](https://samba.anu.edu.au/rsync/documentation.html) and a [tips-and-tricks](https://sial.org/howto/rsync/) page shall add to your knowledge.
...
You shall have a read to this [manual on Samba](https://linux.die.net/man/7/samba).
...
A [scp manual](https://linux.die.net/man/1/scp) is here for reference.
