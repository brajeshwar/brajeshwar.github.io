...
excerpt: The security model for the HTML application sandbox in AIR varies significantly
  ...
  application sandbox.
---
<div class="figure"><img src="{{ site.baseurl }}/assets/2008/04/air-security.jpg" alt="Adobe AIR and Security" />
