...
Adobe has decided to discontinue its Stock Photos service which integrated into Bridge from April 1, 2008. For ASP users, you can download the [Mac](https://www.adobe.com/support/downloads/product.jsp?product=109&platform=Macintosh) and [Windows](https://www.adobe.com/support/downloads/product.jsp?product=109&platform=Windows) unstallers that let you remove ASP from Bridge.
...
- When you're ready, remove Adobe Stock Photos from your Adobe Creative Suite edition or standalone applications. Download the uninstaller: [Mac](https://www.adobe.com/support/downloads/product.jsp?product=109&platform=Macintosh) | [Windows](https://www.adobe.com/support/downloads/product.jsp?product=109&platform=Windows)
