...
The [Fusion Authority](https://www.fusionauthority.com/) Quarterly Update (FAQ-U) is a print publication dedicated to collecting the best and most useful technical articles of high interest to [ColdFusion](https://www.adobe.com/products/coldfusion/) developers. Each issue is based on a theme. The journal is designed to be clear, easy to read and highly informative.

Every quarter, Fusion Authority provide you with the well-written, up-to-date, comprehensive articles that you need to be a ColdFusion professional. Each issue is a mini-book of at least 80 pages of content written by experts -- [Sean Corfield](https://corfield.org/), [Raymond Camden](https://www.coldfusionjedi.com/), [Michael Dinowitz](https://www.houseoffusion.com/), [Hal Helms](https://www.halhelms.com/), Jared Rypka-Hauer, [Joe Rinehart](https://firemoss.com/) and Matt Woodward and many others.
