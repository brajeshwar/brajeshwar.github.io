...
Shwetank Dixit of Opera updated us via [Twitter](https://twitter.com/shwetank) that Opera have an extensive collection of [Web Standards Curriculum](https://www.opera.com/wsc/). The new Curriculum, released in association with the [Yahoo! Developer Network](https://developer.yahoo.com/), is a complete course to teach you standards-based web development, including HTML, CSS, design principles and background theory, and JavaScript basics. It already has support from many organizations (including Yahoo! and the [Web Standards Project](https://www.webstandards.org/)) and universities.