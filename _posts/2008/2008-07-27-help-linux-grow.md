...
- Try and read the [history of Linux](https://en.wikipedia.org/wiki/Linux#History), people who have been there and seen it all - [Sir Eric S. Raymond](https://en.wikipedia.org/wiki/Eric_S._Raymond) and [Sir Richard Stallman](https://en.wikipedia.org/wiki/Richard_Stallman), etc. These people and writings help you learn better.
- Try and hang around more in the [IRCs](https://en.wikipedia.org/wiki/Internet_Relay_Chat) than on social community chat rooms/web-applications. You'll find a far more dedicated group of people in a #suse channel than on twitter or facebook! That's a fact.
