...
The Fall 2008 quarter will mark the beginning of a new class: [CS193P iPhone Application Programming](https://www.stanford.edu/class/cs193p/) from Stanford. The new class is focused on Apple's iPhone application development using Cocoa Touch.
...
The class is being offered via [Stanford Center for Professional Development](https://scpd.stanford.edu/).
