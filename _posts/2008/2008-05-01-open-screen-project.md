...
Today, Adobe [announced](https://www.adobe.com/aboutadobe/pressroom/pressreleases/200804/050108AdobeOSP.html) the Open Screen Project and with it came the ultimate good news -- the SWF and FLV/F4V formats are now totally open source. Adobe has dropped the licensing restrictions on the formats. So, not only can you create tools that writes SWFs (this was already open) but now you can create tools that plays the formats back (you no longer need to just rely on the Flash Player).

The [Open Screen Project](https://www.adobe.com/openscreenproject/) initiative by Adobe is supported by a group of industry leaders, including ARM, Chunghwa Telecom, Cisco, Intel, LG Electronics Inc., Marvell, Motorola, Nokia, NTT DoCoMo, Qualcomm, Samsung Electronics Co., Sony Ericsson, Toshiba and Verizon Wireless.

Well, one of the missing name in the list above is that of [Apple](https://www.apple.com/), which feels that [Flash is not good enough for the iPhone](/2008/flash-on-the-iphone/). It may be remembered that CEO Steve Jobs has publicly criticized Flash for being too slow.
...
The Silicon Alley Insider went ahead to [speculate](https://www.alleyinsider.com/2008/5/adobe_finally_takes_on_apple_google_in_mobile) that Adobe is finally ready to start competing with Google and Apple for mobile platform developers.

What does this mean for the Flash Platform Developers and Designers?

I think Aral put it on a [much better way](https://aralbalkan.com/1332).
...
- [SWF](https://www.adobe.com/devnet/swf/) Specifications
- [FLV](https://www.adobe.com/devnet/flv/) Specifications
- [AMF](https://opensource.adobe.com/wiki/display/blazeds/Developer+Documentation) Specifications
- Open Screen Project [FAQ](https://www.adobe.com/openscreenproject/faq/)