...
I thought [Flash](https://www.adobe.com/go/flash/) Bashing, these days, are done only by the Internet's semi-literates! Coming from a respectable person like James Gosling, the creator of Java is rather uncalled for. Nonetheless, it is understandable since his works somewhat relates him to [JavaFX](https://java.sun.com/javafx/) (supposedly, a competitor to the client side apps of the [Flash Platform](https://www.adobe.com/platform/flash/)). He has all the rights to be on the defensive (rather abusive) perspective towards their extremely successful competitor - Flash.

Redmond Developer News [published an interview](https://reddevnews.com/qandas/article.aspx?editorialsid=121) with Sun Microsystems' James Gosling, in which they discussed JavaFX and its competition in the RIA space. Gosling shared some pointed thoughts on how he believes JavaFX compares to the Flash / Flex platform. 
