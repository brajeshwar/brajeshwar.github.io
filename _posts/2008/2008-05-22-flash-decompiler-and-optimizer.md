...
[Flash Decompiler Trillix](https://www.flash-decompiler.com/mac.html) is perhaps the only tool available for the Mac which can help you regain lost FLA source files. It supports up to Flash 9 and ActionScripts 3.0. The people from Eltima were nice enough to send me a review copy of their software.

[Flash Decompiler Trillix](https://www.flash-decompiler.com/mac.html) can extract images, sounds, video, shapes, morphs, fonts, texts, buttons, sprites, frames and scripts into various file formats. All objects are extracted separately into flash animation (SWF) and flash sources (FLA) file formats, except scripts which can be saved to AS and TXT file formats.
...
Well, if you're on Windows, have a look at [ActionScript Viewer](/2003/actionscript-viewer-40-review/) which is an awesome piece of Flash Decompiler for Windows.
...
The interface allow you to preview the result side-by-side in 1 or 2 built-in players with zooming in/out options. [Flash Optimizer](https://mac.eltima.com/swf-compressor.html) for Mac features the "SWF info" button, which indicates the details of the Flash movie, like percentage of all movie components (pictures, shapes, videos, actions) and both the sizes of original and reduced files. Flash Optimizer fully supports Flash 9.