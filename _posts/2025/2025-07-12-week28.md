...
[OpenCode](https://opencode.ai) is an open source AI coding agent, giving you control and freedom to use any provider, any model, and any editor., built for the terminal. [source](https://github.com/sst/opencode)
