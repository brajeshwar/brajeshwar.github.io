...
I have been planning a revamp for almost a year and when I finally did one, it looks like it needed a revamp tomorrow. But then, let me put that tomorrow for another year! I just saw [Joshuaink](https://joshuaink.com/blog/), that kept me pondering if that is a website or a nicely well-kept, mowed garden where beautiful flowers grow. The site is so nice, clean and wierdly beautiful that made my site look like a rectangular match-box with steel frames. Nothing more can I do than just be jealous and admire that site design.

Onwards, browsing through the galley section at [CSSVault](https://cssvault.com/), I am totally amazed at how people come up with some of the best known UI Designs. Look at the cool UI Designs,
[Spilt Cocoa](https://chiseko.hosted.doosh.net/),
[Folietto](https://www.folietto.at/),
[JoshDura](https://www.joshdura.com/),
[Snook](https://www.snook.ca/jonathan/),
etc.
...
- [Stop quoting URLs](https://www.w3.org/TR/CSS21/syndata.html#uri).
