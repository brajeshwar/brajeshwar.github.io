...
Today, Apollo caught my undivided attention when I saw the post from a *Rich Inter Application Mountaineer*, [Ryan Stewart](https://blog.digitalbackcountry.com/). Ryan wrote about How eBay is developing with Adobe's Apollo. Ryan talks about *San Dimas*, an experimental Apollo powered project from the eBay Developers and [EffectiveUI](https://www.effectiveui.com/).
