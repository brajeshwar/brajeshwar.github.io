...
[del.icio.us direc.tor](https://johnvey.com/features/deliciousdirector/) is a web-based rich UI for [del.icio.us](https://del.icio.us/). It leverages the XML and XSL services of modern browsers to deliver a responsive interface for managing user accounts with a large number of records.
