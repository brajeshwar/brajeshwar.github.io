...
Screenweaver HX is the [haXe](/2005/haxe-programming-language/) wrapper to develop Desktop Application. With [SWHX](https://www.haxe.org/swhx), you create an application by using two layers;
