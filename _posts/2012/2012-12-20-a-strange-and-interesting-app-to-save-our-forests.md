...
Greenpeace India has released an interesting [Facebook App](https://foresthero.org?source=blo) where you can add a picture to a video, portraying you as a 'hero' saving the forests in Central India from coal mining.
...
Nonetheless, [play with the app](https://foresthero.org?source=blo), enjoy the video, watch the parallax scrolling - it should entertain you.
