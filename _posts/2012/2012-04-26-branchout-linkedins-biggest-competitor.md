...
[BranchOut](https://branchout.com/) is a popular Facebook application that is used to search new jobs and can connect with professionals across the globe. The [BranchOut App](https://apps.facebook.com/branchout/) is used to recruit employees as well. 

## About

Launched in July 2010, as of now it has more than 25 million registered users to its credit.  BranchOut is backed by the dedicated team strength of 45 employees. It has grown so smart that [it poses a challenge](https://www.forbes.com/sites/tomtaulli/2012/04/19/branchout-looks-to-dethrone-linkedin/) to a professional dedicated network that connects professionals -- LinkedIn. LinkedIn was launched in the year 2003. It has more than 200 million users which are being benefited from more than 200 countries. The site is available in 13 various languages including English.
