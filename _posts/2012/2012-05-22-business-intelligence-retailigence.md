...
date: 2012-05-22 10:01:19.000000000 +05:30
type: post
parent_id: '0'
published: true
password: ''
...
meta:
  _edit_last: '67'
  _yoast_wpseo_focuskw: Retailigence, startup, start ups, hyperlocal, hyper local,
    retail, brand, developer, interview
  _yoast_wpseo_title: Interview with Peter Christianson from Retailigence
  _yoast_wpseo_metadesc: 'Peter Christianson''s resume looks like a who''s who of
    NASDAQ success stories--so when he created a new startup, Retailigence, people
    paid attention. Retailigence builds on Peter''s portfolio of skills: business
    development, revenue growth, supply chain management, operations research, statistics,
    management consulting, business-process re-engineering and mathematics; skills
    he combined together when to build Retailigence. Retailigence is a hodge podge
    of all those skills, mashed together to create a data-driven, traffic-management
    platform that connects the 3 prongs of the retail sector: retailers, brands and
    developers—all without an app or search engine.'
  dsq_thread_id: '699084934'
  _yoast_wpseo_linkdex: '59'
  onswipe_thumb: http://img.brajeshwar.com/2012/retailigence.png
...
<p>Every culture is different. The culture and management style I use in Japan or Australia or Singapore or Denmark or here in Silicon Valley is very different. I learn and adapt from what I see around me.</p>
