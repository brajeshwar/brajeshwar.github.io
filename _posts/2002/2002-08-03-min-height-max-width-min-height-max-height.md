...
This is possible with the [CSS2 standard (CSS2 standard)](https://www.w3.org/TR/REC-CSS2/) but this does not work in IE 5+. Neverthless, there is a work-around to this, check this [nifty Javascript](https://and.doxdesk.com/file/software/js/minmax.js) that solves the problem. Just tug [this Javascript ()](https://and.doxdesk.com/file/software/js/minmax.js) in your HTML.
