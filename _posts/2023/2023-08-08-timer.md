...
Allocate a specific time for browsing social media or other distracting activities. When the timer goes off, it's a signal to refocus on more important tasks. For instance, I do not want to get sucked into a Rabbit Hole[^RabbitHole] while reading [Hackernews](/2023/hacker-news/). I like setting a timer of about 25 minutes per session to kick me out when the timer ends.
