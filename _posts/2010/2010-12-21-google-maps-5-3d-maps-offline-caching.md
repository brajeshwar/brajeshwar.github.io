...
Most of us have used [Google Maps](https://maps.google.com/) at some point or the other. Either on the desktop or more often on the mobile platform. [Google Maps](https://www.google.com/mobile/maps/3d/) in it's latest avatar uses vector graphics instead of map tiles and it caches some of your most frequently used maps so that they are available offline. The advantage of vector-based maps is multi-fold:
