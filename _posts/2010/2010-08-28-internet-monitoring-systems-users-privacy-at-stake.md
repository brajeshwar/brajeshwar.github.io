...
It was always believed that, only the Security Agencies are willing to access the data flowing through the World Wide Web. This belief has been proved wrong, since now the [Directorate of Revenue Intelligence](https://dor.gov.in/) (DRI) working under the Ministry of Finance are having plans for accessing the [Internet Monitoring Systems](https://www.workexaminer.com/internet-monitoring-software.html). Recently in a meeting of the Inter-Ministerial Group, this proposal was put by forward DRI, and a discussion was carried out.
