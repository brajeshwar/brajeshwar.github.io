...
Some of the most exciting augmented-reality work is Pattie Maes and Pranav Mistry's [SixthSense](https://www.pranavmistry.com/projects/sixthsense/) that relies on some basic components strung together in a lanyard like apparatus that the user wears around his neck.
...
[Layar](https://www.layar.com/) uses the phone's camera and GPS capabilities to gather information about the surrounding area. It then overlays information about restaurants and other establishments in the area on the screen. Pointing the phone at a building will tell you if companies in that building are hiring, or it might be able to find photos of the building on Flickr or locate its history on Wikipedia.

[Yelp's](https://www.yelp.com/) augmented-reality component, Monocle, uses the phone's GPS and compass to display information about local restaurants, including ratings and reviews, on the screen. You can touch one of the listings to find out more about a particular restaurant.

[Le Bar Guide](https://itunes.apple.com/us/app/id335624129?mt=8) will assist you in finding the nearest watering hole, give ratings and even point you to a taxi within stumbling distance. It's accurate to 20 feet.

[WorkSnug](https://worksnug.com/), an iPhone app that finds digital nomads a place to lay their weary laptop. It identifies Wi-Fi hotspots and potential workplaces -- from coffee shops to professional rent-a-desk office spaces --	 with user reviews encompassing power provision, atmosphere, noise levels and even the quality of the coffee.

[Pocket Universe](https://itunes.apple.com/in/app/pocket-universe-virtual-sky/id306916838?mt=8) will spell out the stars, planets and constellations for you. Needing no connectivity, this clever app contains data on 10,000 stars, 88 constellations and lunar phases, while the "tonight's sky" feature shows meteor showers and visible planets based on your location.

[DishPointer](https://www.dishpointer.com/) is designed for satellite installers or mobile broadcasters to hold their phones up to the sky and get a virtual overlay of their nearest satellites to know which way to point the darn dish.

[AugMeasure](https://itunes.apple.com/us/app/augmeasure/id336607546?mt=8) which lets you gauge short distances using on your iPhone's camera.

[Theodolite](https://hunter.pairsite.com/theodolite/) lets you know what axis is bisecting your Northerly inclination and at what altitude. It overlays such data over your camera's image and even lets you snap the screenshot for posterity.

[Car Finder](https://itunes.apple.com/in/app/car-finder/id335295621?mt=8) creates a visible marker showing the car, its distance away and the direction in which to head.

The [Wikitude World Browser AR](https://itunes.apple.com/us/app/wikitude/id329731243?mt=8) app displays data and other points of interest by overlaying information on the real-time camera view.

[Acrossair Nearest Tube App](https://www.acrossair.com/acrossair_app_augmented_reality_nearesttube_london_for_iPhone_3GS.htm) will pin-point where the nearest subway or light rail stations are for the London Tube, Paris Metro, Tokyo Subway, Barcelona Metro, San Francisco Transit, Madrid Metro, and New York Subways.

[Acrossair Twitter App](https://www.acrossair.com/acrossair_app_augmented_reality_nearesttweet_for_iphone_3gs.htm) will display all the tweets around you in 360 degrees of Augmented Reality view, with the distances and photos of the people tweeting around you.
