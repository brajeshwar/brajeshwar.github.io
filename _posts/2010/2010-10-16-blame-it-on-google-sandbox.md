...
Many new site owners are terrified of the "[Google Sandbox](https://en.wikipedia.org/wiki/Sandbox_effect)." Despite claims from staff at Google that such a thing does not exist, these sites insist that new websites are penalized. [Matt Cutts](https://www.mattcutts.com/blog/) has stated that Google's algorithm is based off of trust rankings. Trust is something that must be earned. Newer sites may not have earned trust yet, but they have not lost it either.

Most of the sites at the top of Google are older domains, but that probably has little to do with the fact that they are at the top of the SERP rankings. They have also had time to refine their content, build anchor-rich links and boost their [PageRank](https://en.wikipedia.org/wiki/PageRank). New sites begin with absolutely nothing and must work hard to prove to Google that they deserve to be on the first page for their target keywords.
