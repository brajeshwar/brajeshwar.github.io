...
- Styles
	- {:.CSSclass} is supported by Kramdown in Jekyll. Optional and should not become a eye in the actual plain-text (markdown) file.
		- aside, {:.sidenote} for custom styled aside.
- Images
