...
- __Company__ (referred to as either "I", "the Company", "We", "Us" or "Our" in this Agreement) refers to Brajeshwar.
...
- __Website__ refers to brajeshwar.com, accessible from [https://brajeshwar.com](https://brajeshwar.com)
...
We may allows You to create an account and log in to use the Service through the following Third-party Social Media Services:
